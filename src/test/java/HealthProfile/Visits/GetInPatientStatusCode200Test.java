...
public class GetInPatientStatusCode200Test extends TestBase {
    ...
    public void getInPatient_StatusCode200(long national_id,String Password)
    {
        given()
                .log().all()
