...
public class AddNewBloodPressureReadingForNonHypertensiveStatusCode200Test extends TestBase {
    ...
    public static Object[][] excelDP() {
        ...
        return getDataFromExcel("./datafiles/AutomationData.xlsx", "ValidBlloodPresureNotHyper");
    }
    ...
    public void addNewRecord_StatusCode200(long national_id, String password, long diastolic, long systolic, String messageCode) {
        ...
        given()
                ...
                .body("data.communityAverageSystolic", is(118))
                // verify diastolic community average
                .body("data.communityAverageDiastolic", is(73));
