...
public class AddNewBloodGlucoseReadingForDiabeticStatusCode200Test extends TestBase {
    ...
    public static Object[][] excelDP() {
        ...
        return getDataFromExcel("./datafiles/AutomationData.xlsx", "ValidBloodGlucoseDiabetic");
    }
    ...
    public void addNewGlucoseRecordDiabetic_StatusCode200(long national_id, String password, long reading, boolean fasting, boolean afterTwoHour, String status) {
