...
public class AddNewBloodGlucoseReadingForNonDiabeticStatusCode200Test extends TestBase {
    ...
    public static Object[][] excelDP() {
        ...
        return getDataFromExcel("./datafiles/AutomationData.xlsx", "ValidBloodGlucoseNotDiabetic");
    }
    ...
    public void addNewGlucoseRecordForNotDiabetic_StatusCode200(long national_id, String password, long reading, boolean fasting, boolean afterTwoHour, String status) {
        ...
        given()
                ...
                // verify average
                .body("data.messageCode", is(status));
